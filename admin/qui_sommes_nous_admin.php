...
<html lang="en">
    <head>
        ...
        <title>Agence M&eacute;dicale</title>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-99">
                        <div class="blog-post-area">
                            ...
                            <h2 class="title text-center"><p>Pr&eacute;sentation</p></h2>
                            ...
                            <form id="main-contact-form" class="contact-form row" name="contact-form" action="modif_q_s_n.php" method="post">
